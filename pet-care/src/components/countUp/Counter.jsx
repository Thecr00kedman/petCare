...
const Counter = () => {
  ...
  return (
    <div ref={ref} className='w-11/12 mx-auto my-4'>
      <div className="flex flex-row w-full justify-center items-between bg-[#001144] text-white px-3 py-6 rounded-3xl">
      {stats.map((stat, index) => (
        <div key={index} className="w-full text-center px-8 border-r last:border-none border-white/50">
