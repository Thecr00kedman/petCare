  ...
  return (
    <div className=" bg-white">
        ...
        <div className="flex flex-col gap-6 justify-center text-center items-center m-16">
            ...
            <div className="text-5xl text-[#000D44] font-semibold">What Our Customers Says?</div>
        </div>
      <div>
      <Swiper
        spaceBetween={30}
        ...
        {testimonials?.map((item,index)=>(
            ...
            <div className="flex flex-col gap-8 p-6 bg-[#F5F7FA] rounded-2xl">
                ...
                <div className="flex flex-row justify-between">
                    ...
                    <div>
                        <div className="text-xl font-bold text-[#000D44]">{item?.name}</div>
                        <div className="text-[#788094]">{item?.location}</div>
                    </div>
                    </div>
                    <div className="h-16 w-16">
                        <img className='h-full w-full object-contain' src={Comma} alt="text" />
                    </div>
                </div>
            </div>
        </SwiperSlide>))}
