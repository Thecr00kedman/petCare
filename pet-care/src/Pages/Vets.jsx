  ...
  return (
    <div>
      <div className="my-24">
        ...
        <div>
          <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-5 p-4 bg-white items-center w-10/12 mx-auto my-4 gap-2">
            <div>
              <Select
            ...
            {loading ? (
              ...
              <div className="w-12/12 bg-[#f7f7f5]">
                {dentistsData?.data?.dentists?.map((item, index) => (
                  <div
                    className="flex-col w-full md:w-11/12 lg:w-10/12 mx-auto my-4 bg-white px-2 py-6 border-blue-100 border-b-2 pb-4 gap-8 md:gap-8 lg:gap-8 flex"
                    key={index}
                  >
                    <div className="flex flex-row gap-2 md:gap-4 lg:gap-4" key={index}>
                      <div className="h-52 w-5/12 md:w-3/12 lg:w-3/12 rounded-lg overflow-hidden shadow-lg">
                        <img
                      ...
                      <div className="w-7/12 md:w-9/12 lg:w-9/12 flex flex-col gap-2">
                        ...
                        <div className="flex flex-row gap-2 text-xs text-[#b0b0b0] sm:text-xs md:text-sm lg:text-sm">
                          <Award size={(window.innerWidth >= 1024 ? 32:16) ?( window.innerWidth >= 768 ? 24 : 16) : (window.innerWidth >= 520 ? 16 : 13)} className="text-green-500 flex flex-row items-center" />
                          &nbsp;
                          {item?.educationalQualification?.yearsOfExperience}
                          &nbsp;Years+
                        </div>
                        <div className="flex flex-row gap-2 text-xs text-[#b0b0b0] sm:text-xs md:text-sm lg:text-sm">
                          <Stethoscope size={(window.innerWidth >= 1024 ? 32:16) ?( window.innerWidth >= 768 ? 24 : 16) : (window.innerWidth >= 520 ? 16 : 13)} className="text-green-500 flex flex-row items-center" />
                          &nbsp;{item?.personalDetails?.specialty}
                        </div>
                        <div className="flex flex-row gap-2 text-xs text-[#b0b0b0] sm:text-xs md:text-sm lg:text-sm">
                          <div><User size={(window.innerWidth >= 1024 ? 32:16) ?( window.innerWidth >= 768 ? 24 : 16) : (window.innerWidth >= 520 ? 16 : 13)} className="text-green-500 flex flex-row items-center" /></div>
                          {item?.personalDetails?.Bio}
                        </div>
                        <div className="flex flex-row gap-2 text-xs text-[#b0b0b0] sm:text-xs md:text-sm lg:text-sm">
                          <Wallet size={(window.innerWidth >= 1024 ? 32:16) ?( window.innerWidth >= 768 ? 24 : 16) : (window.innerWidth >= 520 ? 16 : 13)} className="text-green-500 flex flex-row items-center" />
                          ₹&nbsp;{item?.fee || "200"}
                        </div>
                      </div>
                    ...
                    <div className="lg:hidden flex sm:flex-row sm:mx-auto sm:my-2 gap-4 items-center justify-center sm:w-full w-full">
                      ...
                      <Dialog>
                            ...
                            <DialogContent className='w-11/12 mx-auto my-2 md:w-full lg:w-full'>
                              <DialogHeader className="flex flex-col gap-5">
